...
''' opt for data '''
parser.add_argument('--data','-d', metavar='DATA', default='./data/CUB_200_2011/CUB_200_2011/images/',
                    help='dataset')
...
parser.add_argument('--seed', default=8432, type=int,
                    help='seed for initializing training. ')
parser.add_argument('--seed1', default=5554, type=int,
                    help='seed1 for initializing training. ')
parser.add_argument('--seed2', default=9169, type=int,
...
parser.add_argument('--resume', default='./cub.model', type=str, metavar='PATH',

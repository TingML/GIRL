...
''' opt for data '''
parser.add_argument('--data','-d', metavar='DATA', default='./images',
                    help='dataset')
parser.add_argument('--data-name', default='sun', type=str, help='dataset')
# multi-gpu
parser.add_argument('-j', '--workers', default=16, type=int, metavar='N',
                    help='number of data loading workers (default: 32)')
parser.add_argument("--local_rank", type=int, default=0)
parser.add_argument('--seed', default=9007, type=int,
                    help='seed for initializing training. ')
parser.add_argument('--seed1', default=9007, type=int,
                    help='seed1 for initializing training. ')
parser.add_argument('--seed2', default=5224, type=int,
...
parser.add_argument('--att-emb-dim', default=21, type=int, help='')

''' opt for others '''
parser.add_argument('--save-path', '-s', metavar='SAVE', default='./trainmodel',
                    help='saving path')
...
parser.add_argument('--resume', default='./sun.model', type=str, metavar='PATH',
